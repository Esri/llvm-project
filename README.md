...
```sh
docker build --platform=linux/amd64 --tag=llvm:19.1.0-amd64 - < ${HOME}/llvm/llvm-project/llvm.dockerfile
docker build --platform=linux/arm64 --tag=llvm:19.1.0-arm64 - < ${HOME}/llvm/llvm-project/llvm.dockerfile
```
...
`docker run --rm -it -u $(id -u):$(id -g) --volume ${HOME}/llvm:/llvm --workdir /llvm llvm:19.1.0-amd64 bash`
...
`docker run --rm -it -u $(id -u):$(id -g) --volume ${HOME}/llvm:/llvm --workdir /llvm llvm:19.1.0-arm64 bash`
...
```bash
$ diff -r aarch64-unknown-linux-gnu/19.1.0 x86_64-unknown-linux-gnu/19.1.0/ | grep -v 'Binary files'
Only in aarch64-unknown-linux-gnu/19.1.0/include: aarch64-unknown-linux-gnu
Only in x86_64-unknown-linux-gnu/19.1.0/include: x86_64-unknown-linux-gnu
Only in aarch64-unknown-linux-gnu/19.1.0/lib: aarch64-unknown-linux-gnu
Only in aarch64-unknown-linux-gnu/19.1.0/lib/clang/19/lib: aarch64-unknown-linux-gnu
Only in x86_64-unknown-linux-gnu/19.1.0/lib/clang/19/lib: x86_64-unknown-linux-gnu
Only in x86_64-unknown-linux-gnu/19.1.0/lib: x86_64-unknown-linux-gnu

cp -r aarch64-unknown-linux-gnu/19.1.0/include/aarch64-unknown-linux-gnu x86_64-unknown-linux-gnu/19.1.0/include/
cp -r x86_64-unknown-linux-gnu/19.1.0/include/x86_64-unknown-linux-gnu aarch64-unknown-linux-gnu/19.1.0/include/
cp -r aarch64-unknown-linux-gnu/19.1.0/lib/aarch64-unknown-linux-gnu x86_64-unknown-linux-gnu/19.1.0/lib/
cp -r x86_64-unknown-linux-gnu/19.1.0/lib/x86_64-unknown-linux-gnu aarch64-unknown-linux-gnu/19.1.0/lib/
cp -r aarch64-unknown-linux-gnu/19.1.0/lib/clang/19/lib/aarch64-unknown-linux-gnu x86_64-unknown-linux-gnu/19.1.0/lib/clang/19/lib/
cp -r x86_64-unknown-linux-gnu/19.1.0/lib/clang/19/lib/x86_64-unknown-linux-gnu aarch64-unknown-linux-gnu/19.1.0/lib/clang/19/lib/
...
```bash
cd ${HOME}/llvm/x86_64-unknown-linux-gnu && zip -r llvm-19.1.0-x86_64.zip 19.1.0
cd ${HOME}/llvm/aarch64-unknown-linux-gnu && zip -r llvm-19.1.0-aarch64.zip 19.1.0
```
